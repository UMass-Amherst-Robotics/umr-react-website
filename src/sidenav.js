...
export default function TemporaryDrawer() {
  ...
  const list = (anchor) => (
    ...
    >
      <List>
        <ListItemLink button key={'Home'} href='/umr-react-website/#/'><ListItemIcon><HomeIcon /></ListItemIcon><ListItemText primary={'Home'} /></ListItemLink>
      ...
      <Collapse in={open} timeout="auto" unmountOnExit>
        ...
        <ListItemLink button key={'Meet the Team'} className={classes.nested} href={'/umr-react-website/#/meet-the-team'}><ListItemIcon><PersonIcon /></ListItemIcon><ListItemText primary={'Meet the Team'} /></ListItemLink>
        <ListItemLink button key={'NASA Lunabotics 2020-2021'} className={classes.nested} href={'/umr-react-website/#/nasa-lunabotics-2020-2021'}><ListItemIcon><GradeIcon /></ListItemIcon><ListItemText primary={'NASA Lunabotics 2020-2021'} /></ListItemLink>
        </List>
      </Collapse>
